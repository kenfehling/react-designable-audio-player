...
var TS = function (_Component3) {
  (0, _inherits3.default)(TS, _Component3);

  function TS(props) {
    (0, _classCallCheck3.default)(this, TS);

    var _this5 = (0, _possibleConstructorReturn3.default)(this, (TS.__proto__ || (0, _getPrototypeOf2.default)(TS)).call(this, props));
  ...
  (0, _createClass3.default)(TS, [{
    ...
    value: function componentDidMount() {
      ...
      this.listenerId = (0, _audioPlayerCore.addListener)(function (update) {
        ...
        _this6.setState({ secondsElapsed: secondsElapsed, secondsRemaining: secondsRemaining });
      });
    }
  }, {
    key: 'componentWillUnmount',
...
var PL = function (_Component4) {
  (0, _inherits3.default)(PL, _Component4);

  function PL(props) {
    (0, _classCallCheck3.default)(this, PL);

    var _this7 = (0, _possibleConstructorReturn3.default)(this, (PL.__proto__ || (0, _getPrototypeOf2.default)(PL)).call(this, props));
  ...
  (0, _createClass3.default)(PL, [{
    ...
    value: function componentDidMount() {
      ...
      this.listenerId = (0, _audioPlayerCore.addListener)(function (update) {
        ...
        _this8.setState({ tracks: tracks, currentTrack: currentTrack });
      });
    }
  }, {
    key: 'componentWillUnmount',
