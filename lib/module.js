...
import $zIto6$bundletextrcsliderassetsindexcss from "bundle-text:rc-slider/assets/index.css";
...
function $cea81b3248d66e10$export$c0b03e78d1b6fede(WrappedComponent, tracks, { autoplay: autoplay = false  } = {}) {
    class Connect extends (0, $zIto6$Component) {
        constructor(props){
            ...
            styleEl.textContent = (0, $zIto6$bundletextrcsliderassetsindexcss);
            shadow.appendChild((0, $zIto6$bundletextrcsliderassetsindexcss));
        }
        componentDidMount() {
...
class $cea81b3248d66e10$var$TM extends (0, $zIto6$Component) {
    constructor(props){
        ...
        if (0, $zIto6$canUseDOM) (0, $zIto6$insertcss)(`@keyframes ${$cea81b3248d66e10$var$marqueeAnimationName} {
