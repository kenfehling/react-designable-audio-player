...
var $gXNCa$fbjslibExecutionEnvironment = require("fbjs/lib/ExecutionEnvironment");
var $gXNCa$rcslider = require("rc-slider");
var $gXNCa$insertcss = require("insert-css");
...
const $7bdda7b4f80009e0$var$audio = (0, $gXNCa$fbjslibExecutionEnvironment.canUseDOM) ? new Audio() : null;
...
const $7bdda7b4f80009e0$export$5106570dc4737ef5 = (0, $gXNCa$fbjslibExecutionEnvironment.canUseDOM) ? (newTracks)=>{
...
const $7bdda7b4f80009e0$export$899fbdb5fa08b653 = (0, $gXNCa$fbjslibExecutionEnvironment.canUseDOM) ? ()=>{
...
const $7bdda7b4f80009e0$export$fa6813432f753b0d = (0, $gXNCa$fbjslibExecutionEnvironment.canUseDOM) ? ()=>{
    $7bdda7b4f80009e0$var$audio.pause();
...
const $7bdda7b4f80009e0$export$990806b8ad8af834 = (0, $gXNCa$fbjslibExecutionEnvironment.canUseDOM) ? (seconds)=>{
...
const $7bdda7b4f80009e0$export$48cfd1e771a65c4f = (0, $gXNCa$fbjslibExecutionEnvironment.canUseDOM) ? ()=>{
...
const $7bdda7b4f80009e0$export$232faf9add678146 = (0, $gXNCa$fbjslibExecutionEnvironment.canUseDOM) ? ()=>{
...
const $7bdda7b4f80009e0$export$e64e955830870e84 = (0, $gXNCa$fbjslibExecutionEnvironment.canUseDOM) ? (number)=>{
    $7bdda7b4f80009e0$var$currentTrackIndex = number - 1;
    $7bdda7b4f80009e0$var$switchTrack();
} : $7bdda7b4f80009e0$var$noop;
const $7bdda7b4f80009e0$export$2735a780d8a99a8c = (0, $gXNCa$fbjslibExecutionEnvironment.canUseDOM) ? (number)=>{
...
const $7bdda7b4f80009e0$export$9a5e51d3b9fed543 = (0, $gXNCa$fbjslibExecutionEnvironment.canUseDOM) ? ()=>{
...
if (0, $gXNCa$fbjslibExecutionEnvironment.canUseDOM) {
...
function $8fa9287ca73b387b$export$c0b03e78d1b6fede(WrappedComponent, tracks, { autoplay: autoplay = false  } = {}) {
    class Connect extends (0, $gXNCa$react.Component) {
        constructor(props){
            super(props);
            this.state = {
                isPlaying: false,
        ...
        render() {
            ...
            return /*#__PURE__*/ (0, $gXNCa$react.createElement)(WrappedComponent, {
                ...this.props,
                ...props
            });
        }
...
class $8fa9287ca73b387b$var$TM extends (0, $gXNCa$react.Component) {
    constructor(props){
        super(props);
        this.state = {
            on: true,
        ...
        if (0, $gXNCa$fbjslibExecutionEnvironment.canUseDOM) (0, ($parcel$interopDefault($gXNCa$insertcss)))(`
        @import url('rc-slider/assets/index.css');
        @keyframes ${$8fa9287ca73b387b$var$marqueeAnimationName} {
    ...
    render() {
        ...
        return /*#__PURE__*/ (0, ($parcel$interopDefault($gXNCa$react))).createElement("div", {
            className: className
        }, /*#__PURE__*/ (0, ($parcel$interopDefault($gXNCa$react))).createElement("div", {
            style: {
                overflow: "hidden",
                whiteSpace: "nowrap"
            }
...
$8fa9287ca73b387b$var$TM.propTypes = {
    ...
    textFn: (0, ($parcel$interopDefault($gXNCa$proptypes))).func,
    duration: (0, ($parcel$interopDefault($gXNCa$proptypes))).number
};
const $8fa9287ca73b387b$export$b59c99f47fcbedf1 = $8fa9287ca73b387b$var$TM;
/* TimeSlider component */ class $8fa9287ca73b387b$var$DefaultSliderHandle extends (0, $gXNCa$react.Component) {
    render() {
        return /*#__PURE__*/ (0, ($parcel$interopDefault($gXNCa$react))).createElement("div", null);
    }
}
class $8fa9287ca73b387b$var$TS extends (0, $gXNCa$react.Component) {
    constructor(props){
        super(props);
        this.state = {
            secondsElapsed: 0,
    ...
    render() {
        ...
        return /*#__PURE__*/ (0, ($parcel$interopDefault($gXNCa$react))).createElement("div", {
            className: className
        }, /*#__PURE__*/ (0, ($parcel$interopDefault($gXNCa$react))).createElement((0, ($parcel$interopDefault($gXNCa$rcslider))), {
            onChange: (0, $7bdda7b4f80009e0$export$990806b8ad8af834),
            value: secondsElapsed,
            min: 0,
            max: secondsElapsed + secondsRemaining,
            handle: this.props.handle || /*#__PURE__*/ (0, ($parcel$interopDefault($gXNCa$react))).createElement($8fa9287ca73b387b$var$DefaultSliderHandle, null),
            ...props
        }));
    }
}
...
/* Playlist component */ class $8fa9287ca73b387b$var$PL extends (0, $gXNCa$react.Component) {
    constructor(props){
        super(props);
        this.state = {
            tracks: [],
    ...
    render() {
        ...
        return /*#__PURE__*/ (0, ($parcel$interopDefault($gXNCa$react))).createElement("div", {
            className: className
        }, tracks.map((track, i)=>/*#__PURE__*/ (0, ($parcel$interopDefault($gXNCa$react))).createElement("div", {
                key: i,
...
$8fa9287ca73b387b$var$PL.propTypes = {
    className: (0, ($parcel$interopDefault($gXNCa$proptypes))).string,
    itemClassName: (0, ($parcel$interopDefault($gXNCa$proptypes))).string,
    currentItemClassName: (0, ($parcel$interopDefault($gXNCa$proptypes))).string,
    itemComponent: (0, ($parcel$interopDefault($gXNCa$proptypes))).func
};
